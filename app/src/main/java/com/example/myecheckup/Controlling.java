...
public class Controlling extends Activity {
    ...
    Button btnOn,btnOff, temperature;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assert b != null;
        mDevice = b.getParcelable(Home.DEVICE_EXTRA);
        mDeviceUUID = UUID.fromString(b.getString(Home.DEVICE_UUID));
        mMaxChars = b.getInt(Home.BUFFER_SIZE);
...
// TODO Auto-generated method stub
                try {
                    ...
                    BluetoothDevice device = ((Home.MyAdapter) (Home.listView.getAdapter())).getSelectedItem();
                    Intent intent = new Intent(getApplicationContext(), MonitoringScreen.class);
                    intent.putExtra(Home.DEVICE_EXTRA, device);
                    intent.putExtra(Home.DEVICE_UUID, mDeviceUUID.toString());
                    intent.putExtra(Home.BUFFER_SIZE, mBufferSize);
...
// TODO Auto-generated catch block
    ...
    protected class DisConnectBT extends AsyncTask<Void, Void, Void> {
